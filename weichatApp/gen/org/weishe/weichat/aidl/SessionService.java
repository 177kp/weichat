 ...
 * Original file: F:\\vshe\\weichatApp\\src\\org\\weishe\\weichat\\aidl\\SessionService.aidl
 */
package org.weishe.weichat.aidl;
public interface SessionService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements org.weishe.weichat.aidl.SessionService
{
 ...
 */
public static org.weishe.weichat.aidl.SessionService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof org.weishe.weichat.aidl.SessionService))) {
return ((org.weishe.weichat.aidl.SessionService)iin);
}
return new org.weishe.weichat.aidl.SessionService.Stub.Proxy(obj);
}
...
private static class Proxy implements org.weishe.weichat.aidl.SessionService
{
...
/**
  *发送消息
  */
@Override public void sendMessage(java.lang.String uuid, int contentType, java.lang.String message, int toId, int msgType, java.lang.String fileGroupName, java.lang.String filePath) throws android.os.RemoteException
{
...
/**
  *发送文件消息
  */
@Override public void sendAttachment(long id) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
  *获取朋友列表
  */
@Override public void getFriendList() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
  *获取朋友分组列表
  */
@Override public void getFriendGroupsList() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
  *获取朋友群组列表
  */
@Override public void getChatGroupList() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
  *获取群组成员列表
  */
@Override public void getChatGroupMemberList(int groupId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
  *获取所在讨论组列表
  */
@Override public void getDiscussionGroupList() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
  *获取讨论组成员列表
  */
@Override public void getDiscussionGroupMemberList(int dGroupId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
  *获取用户聊天消息 
  */
@Override public void getMessageList(int fromMessageId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
  *获取用户待办消息
  */
@Override public void getTodoList(int fromMessageId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
  *获取与我相关的用户
  */
@Override public void getRelateUser() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
